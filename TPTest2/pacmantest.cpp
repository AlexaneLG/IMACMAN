...
int main(int argc, char** argv) {
    ...
    while(!done) {
        ...
        //Lights
        glm::vec3 lightIntensity = glm::vec3(10,0.55,1);
        ...
        int size = nbCols*nbRows;
        for(int i =0; i < size ; i++){
            if(i%2 !=0 || i < nbCols || i > size - nbRows){
                elements.push_back(1);
            } else {
                elements.push_back(0);
            }
        }
        glm::mat4 mazeMVMatrix = globalMVMatrix;//glm::scale(glm::mat4(1), glm::vec3(0.2,0.2, 0.2));
        for(int i = 0; i < nbRows; i++){
            ...
            mazeMVMatrix = glm::translate(mazeMVMatrix, glm::vec3(-width*nbCols, 0, 0));
